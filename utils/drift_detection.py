...
class DriftDetector:
    ...
    def detect_feature_drift(
        self, baseline_data: pd.DataFrame, current_data: pd.DataFrame, feature_cols: List[str] = ["ability_truth"]
    ) -> Dict:
        """
        ...
        """
        drift_results = {"timestamp": datetime.now().isoformat(), "features": {}, "has_drift": False}
    ...
    def detect_concept_drift(self, baseline_accuracy: float, current_accuracy: float) -> Dict:
        """
    ...
    def check_and_alert(
        ...
        if feature_drift["has_drift"]:
            ...
            self.log_alert({"alert_type": "feature_drift", "details": feature_drift})
        ...
        if baseline_accuracy is not None and current_accuracy is not None:
            ...
            if concept_drift["has_drift"]:
                results["has_any_drift"] = True
                self.log_alert({"alert_type": "concept_drift", "details": concept_drift})
