...
class DKTModelAdvanced(nn.Module):
    ...
    def __init__(
        ...
        # Embedding
        self.embedding = nn.Embedding(num_embeddings=2 * n_items + 1, embedding_dim=hidden_size, padding_idx=0)
    ...
    def predict_with_uncertainty(self, inputs: torch.Tensor, n_samples: int = 10) -> Tuple[torch.Tensor, torch.Tensor]:
        """
...
def load_model_advanced(load_path: str, device: str = "cpu", use_mc_dropout: bool = False) -> Tuple[nn.Module, Dict]:
    """
